...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Dashboard for IndoCyber" />

    <title>IndoCyber - Dashboard</title>
      ...
      <section>
        ...
        <nav class="nav-content gap-5">
          <div class="d-flex gap-3 align-items-center">
            {{-- <img
              src="{{ asset('backend/assets/images/photo.webp') }}"
              alt="Photo Profile"
              class="photo-profile"
            /> --}}
            <div>
      ...
      {{-- <section class="d-flex flex-column gap-4">
        ...
        <div class="d-flex gap-4 flex-wrap">
          <div class="product-card">
            <img
              src="{{ asset('backend/assets/images/nike_red.png') }}"
              alt="Nike Red"
              width="260"
              height="180"
            />
          ...
          <div class="product-card">
            <img
              src="{{ asset('backend/assets/images/nike_airforce.png') }}"
              alt="Nike Airforce"
              width="260"
              height="180"
            />
          ...
          <div class="product-card">
            <img
              src="{{ asset('backend/assets/images/nike_kiger.png') }}"
              alt="Nike Kiger"
              width="260"
              height="180"
            />
